        ...
        <Card className="mx-1 border-none">
          <CardHeader className="space-y-1.5">
            <div className="flex items-center justify-between gap-3">
              <CardTitle className="text-md">Report Health</CardTitle>

              <Badge className="bg-emerald-300 text-foreground dark:bg-emerald-500">
                Live demo
              </Badge>
            </div>
          ...
          <CardContent className="space-y-5">
            ...
            <div className="grid gap-3">
              {sidebarMetrics.map((metric) => {
                ...
                return (
                  <div
                    key={metric.label}
                    className="flex items-center justify-between rounded-lg border bg-muted/30 p-1.5"
                  >
                    ...
                    <div className="px-1 font-mono text-sm font-semibold">
                      {metric.value}
                    </div>
                  </div>
                );
            ...
            <div className="rounded-lg border bg-muted/30 p-4">
              ...
              <p className="text-xs text-muted-foreground">
                Assign reviewers to unclaimed sections before generating the
                final report.
              </p>
            </div>
          </CardContent>
