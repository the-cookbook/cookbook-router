...
function isValidTimeRange(tab: string | undefined): tab is TimeRange {
  return timeRanges.includes(tab as TimeRange);
}
    ...
    <Card className="@container/card">
      <CardHeader>
        ...
        <CardAction>
          ...
          <Select value={timeRange} onValueChange={handleOnTabChange}>
            <SelectTrigger
